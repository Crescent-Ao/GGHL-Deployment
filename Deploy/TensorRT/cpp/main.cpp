...
void draw_objects(cv::Mat bgr, vector<OBBInfo8> objects)
{
    ...
    cv::imwrite("/home/crescent/GGHL/Deploy/TensorRT/cpp/QAQ858.png", img);
}
class GGHLONNX
{
public:
...
{
    string input_image_path = "/home/crescent/images/P0006__1024__30___0.png";
    //这边进行一个初始化的过程
    const char *onnxfilename = "/home/crescent/GGHL_demo/GGHL.onnx";
    string engine_file = "/home/crescent/GGHL/Deploy/GGHL.trt";
